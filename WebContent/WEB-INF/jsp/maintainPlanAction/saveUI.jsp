...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="maintainPlan_%{id==null?'add':'edit'}">
      ...
      <s:hidden name="id"></s:hidden>
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" /> 维修计划</div> 
        </div>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>CMM type</td>
                         <td><s:textfield name="cmmtype" cssClass="InputStyle"/> </td>
                    </tr>
                    <tr><td>Maintenance Plan</td>
						<td><s:textfield name="plan" cssClass="InputStyle"/> </td>
                    </tr>
                    <tr><td>Order</td>
                         <td><s:textfield name="number" cssClass="InputStyle"/> </td>
                    </tr>
                     <tr><td>X axis</td>
                         <td><s:textfield name="xaxis" cssClass="InputStyle"/> </td>
                    </tr>
                     <tr><td>备注</td>
