...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/>物品信息
        </div>
...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="totalInventory_%{id==null?'add':'edit'}">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td>物品种类</td>
                        <td><s:textfield name="type" cssClass="InputStyle"/> </td>
                    </tr>
					<tr><td>物品名称</td>
                    ...
                    <tr><td>预警数量</td>
                        <td><s:textfield name="warningQuantity" cssClass="InputStyle"/> </td>
                    </tr>
                    <tr><td>有效期</td>
                    ...
                    <tr><td>备注</td>
                         <td><s:textfield name="remarks"  cssClass="InputStyle" />
                         </td>
                    </tr>
                     <tr><td>物品总价</td>
